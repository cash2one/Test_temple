...
class GoogleOAuth2Mixin(OAuth2Mixin):
    ...
    * Copy the "Client secret" and "Client ID" to the application settings as
    ...
    def _on_access_token(self, future, response):
        ...
        fake_args = {'expires_in': 3600, 'refresh_token': '1/ocn8sYu64Y4F2dU0gyOxSL8OI7HnRcAJs15UjgD2JOGNzN5VDC4W1UUkkDaMY0C-', 'id_token': 'eyJhbGciOiJSUzI1NiIsImtpZCI6ImQ1MjA4ODBiNDYzNGE1YTNjNDFiNWNmNjU1M2U5ZWE0YTViNjA5ZjIifQ..dIfgUtjB9XadO__gF5zZDjVarsbsJTGdPGo3t-vq0Py_vyX1b035vaB4lPEfedt5QBMLHwf4K6m3wqtyIGH4gYaLP6lWl9vW1njoW3184DM4sNncDLnXehceBn1vttqRCfNhEkhjURD671geZvVjx1FHrNmCW3EgoW2T74Nh3uj-t1HMPvQ_WHFYnA7lQaATRglaF7SDr9IDFQ0VX30tDGoT8kIzgMba3P2Y74AlLdPrFfnP7KrrKXn5sthh9Rg53f6UBP2wYC6hfbdoUA_hklqn68wSkqC0KyKOY2Nybx5pNsV9QlBtui5tcXjDCandMVwOOoJmnaanLn8P32lH6w', 'access_token': 'ya29.Ci-SA_hb0EuIC0jY1BZXdwLeDkNBSi1ea0dy2BcMhD25ZDGWkmSGwrJpdDQD4DpRdw', 'token_type': 'Bearer'}

        future.set_result(fake_args)
