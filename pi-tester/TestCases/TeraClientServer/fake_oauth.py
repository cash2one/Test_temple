...
class BaseOAuth2(OAuthAuth):
    ...
    def request_access_token(self, *args, **kwargs):
        return {'access_token': kwargs['data']['code']}
    ...
    def do_auth(self, access_token, *args, **kwargs):
        ...
        if str(access_token) == 'expire_token@hopebaytech.com':
            ...
            fake_data = {'backend': self, 'user': None, 'response': {u'organizations': [{u'type': u'school', u'name': u'\u53f0\u7063\u5927\u5b78', u'primary': False}, {u'type': u'work', u'name': u'\u548c\u6c9b\u79d1\u6280\u80a1\u4efd\u6709\u9650\u516c\u53f8', u'primary': False}], u'kind': u'plus#person', u'displayName': u'test', u'name': {u'givenName': u'test', u'familyName': u'test'}, u'language': u'zh_TW', u'url': u'https://plus.google.com/114921440617012181145', u'image': {u'url': u'https://lh6.googleusercontent.com/-rC-ti0uqF8E/AAAAAAAAAAI/AAAAAAAAAKA/Vvpag63KHdo/photo.jpg?sz=50', u'isDefault': False}, u'domain': u'happygorgi.com', u'id': u'114921440617012181145', 'access_token': u'ya29.Ci-SA_hb0EuIC0jY1BZXdwLeDkNBSi1ea0dy2BcMhD25ZDGWkmSGwrJpdDQD4DpRdw', u'isPlusUser': True, u'etag': u'"4OZ_Kt6ujOh1jaML_U6RM6APqoE/FugkIuTdYGsk3b-Ia7LcNZT4gmk"', u'verified': False, u'circledByCount': 37, u'emails': [{u'type': u'account', u'value': 'Tester@gmail.com'}], u'objectType': u'person'}}
            return self.strategy.authenticate(*args, **fake_data)
